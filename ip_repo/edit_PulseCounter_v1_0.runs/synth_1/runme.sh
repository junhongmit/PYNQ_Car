...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/ip_repo/edit_PulseCounter_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseCounter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PulseCounter_v1_0.tcl
