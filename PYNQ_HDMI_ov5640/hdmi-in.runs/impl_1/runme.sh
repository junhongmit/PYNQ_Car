...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_HDMI_ov5640/hdmi-in.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PYNQ_HDMI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PYNQ_HDMI_wrapper.tcl -notrace
