...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_HDMI_ov5640/hdmi-in.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PYNQ_HDMI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PYNQ_HDMI_wrapper.tcl
