...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_HDMI_ov5640/hdmi-in.runs/PYNQ_HDMI_v_osd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PYNQ_HDMI_v_osd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PYNQ_HDMI_v_osd_0_0.tcl
