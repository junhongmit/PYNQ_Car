...
################################################################
# This is a generated script based on design: PYNQ_HDMI
#
...
proc create_hier_cell_CAM_IN_PIPE { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 7 -to 0 CMOS_DATA_0
  create_bd_pin -dir O CMOS_ENA_0
  create_bd_pin -dir I CMOS_PIXCLK_0
  ...
  # Create instance: PIC_LAY_0, and set properties
  set PIC_LAY_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PIC_LAY:720p PIC_LAY_0 ]
  ...
  connect_bd_net -net CMOS_DATA_0_1 [get_bd_pins CMOS_DATA_0] [get_bd_pins PIC_LAY_0/CMOS_DATA] [get_bd_pins ila_0/probe0]
  connect_bd_net -net CMOS_PIXCLK_0_1 [get_bd_pins CMOS_PIXCLK_0] [get_bd_pins PIC_LAY_0/CMOS_PIXCLK] [get_bd_pins ila_0/clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  connect_bd_net -net PIC_LAY_0_CMOS_ENA [get_bd_pins CMOS_ENA_0] [get_bd_pins PIC_LAY_0/CMOS_ENA]
  connect_bd_net -net PIC_LAY_0_RGB_DATA [get_bd_pins PIC_LAY_0/RGB_DATA] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net PIC_LAY_0_RGB_DVAL [get_bd_pins PIC_LAY_0/RGB_DVAL] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net PIC_LAY_0_SYNC_DMA [get_bd_pins PIC_LAY_0/SYNC_DMA] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins PIC_LAY_0/CLOCK_in] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net frame_valid_in_1 [get_bd_pins frame_valid_in] [get_bd_pins PIC_LAY_0/CMOS_FVAL]
  connect_bd_net -net line_valid_in_1 [get_bd_pins line_valid_in] [get_bd_pins PIC_LAY_0/CMOS_LVAL]
  connect_bd_net -net proc_sys_reset_2_peripheral_reset [get_bd_pins PIC_LAY_0/reset] [get_bd_pins proc_sys_reset_2/peripheral_reset] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_reset]
...
proc create_root_design { parentCell } {
  ...
  set CMOS_ENA [ create_bd_port -dir O CMOS_ENA ]
  set CMOS_FVAL [ create_bd_port -dir I CMOS_FVAL ]
  set CMOS_LVAL [ create_bd_port -dir I CMOS_LVAL ]
  set CMOS_PIXCLK [ create_bd_port -dir I CMOS_PIXCLK ]
  ...
  set_property -dict [ list \
   CONFIG.BG_COLOR0 {0} \
   CONFIG.BG_COLOR1 {48} \
   CONFIG.BG_COLOR2 {226} \
   CONFIG.HAS_AXI4_LITE {false} \
   CONFIG.LAYER0_ENABLE {true} \
   CONFIG.LAYER0_HEIGHT {800} \
   CONFIG.LAYER0_HORIZONTAL_START_POSITION {320} \
   CONFIG.LAYER0_VERTICAL_START_POSITION {140} \
   CONFIG.LAYER0_WIDTH {1280} \
   CONFIG.LAYER1_ENABLE {false} \
  ...
  # Create port connections
  connect_bd_net -net CAM_IN_PIPE_CMOS_ENA_0 [get_bd_ports CMOS_ENA] [get_bd_pins CAM_IN_PIPE/CMOS_ENA_0]
  connect_bd_net -net CAM_IN_PIPE_clk_out1 [get_bd_ports XCLK] [get_bd_pins CAM_IN_PIPE/clk_out1]
  connect_bd_net -net CMOS_DATA_0_1 [get_bd_ports CMOS_DATA] [get_bd_pins CAM_IN_PIPE/CMOS_DATA_0]
  connect_bd_net -net CMOS_PIXCLK_0_1 [get_bd_ports CMOS_PIXCLK] [get_bd_pins CAM_IN_PIPE/CMOS_PIXCLK_0]
  connect_bd_net -net aclken_1 [get_bd_pins CAM_IN_PIPE/aclken] [get_bd_pins v_osd_0/aclken] [get_bd_pins v_osd_0/aresetn] [get_bd_pins v_tc_0/clken] [get_bd_pins vcc/dout] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_pins axi_dynclk_0/PXL_CLK_O] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_osd_0/aclk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net hs_in_1 [get_bd_ports CMOS_LVAL] [get_bd_pins CAM_IN_PIPE/line_valid_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CAM_IN_PIPE/s_axi_aclk] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins CAM_IN_PIPE/aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_150M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins CAM_IN_PIPE/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in] [get_bd_pins rst_processing_system7_0_150M/ext_reset_in]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_reset [get_bd_pins CAM_IN_PIPE/reset] [get_bd_pins rst_processing_system7_0_100M/peripheral_reset]
  ...
  connect_bd_net -net rst_processing_system7_0_150M_peripheral_aresetn [get_bd_pins CAM_IN_PIPE/aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins rst_processing_system7_0_150M/peripheral_aresetn]
  connect_bd_net -net vs_in_1 [get_bd_ports CMOS_FVAL] [get_bd_pins CAM_IN_PIPE/frame_valid_in]
