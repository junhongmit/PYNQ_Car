...
xilinx.com:user:CAM_interface:1.0\
...
proc create_hier_cell_CAM_IN_PIPE { parentCell nameHier } {
  ...
  connect_bd_net -net CAM_interface_0_Dout [get_bd_pins CAM_interface_0/Dout] [get_bd_pins ila_0/probe0] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins CAM_interface_0/pclk_out] [get_bd_pins ila_0/clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pixel_in_0_1 [get_bd_ports pixel_in] [get_bd_pins CAM_IN_PIPE/pixel_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CAM_IN_PIPE/s_axi_aclk] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
