...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/src/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/install)
...
if(NOT "/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/src/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/src/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/src/openslam_gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/junhonglin/Xilinx/PYNQ_Car/PYNQ_Car/devel/lib;/opt/ros/melodic/lib)
