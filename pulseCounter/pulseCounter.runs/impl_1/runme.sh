...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/pulseCounter/pulseCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseCounter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PulseCounter_wrapper.tcl -notrace
