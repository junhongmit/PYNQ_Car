...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/pulseCounter/pulseCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PulseCounter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PulseCounter_wrapper.tcl
