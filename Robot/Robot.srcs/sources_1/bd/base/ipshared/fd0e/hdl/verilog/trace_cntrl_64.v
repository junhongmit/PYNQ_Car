...
(* CORE_GENERATION_INFO="trace_cntrl_64,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.346000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=849,HLS_SYN_LUT=1113,HLS_VERSION=2018_2}" *)
...
reg   [0:0] tmp_1_reg_287_pp0_iter1_reg;
reg   [0:0] tmp_7_reg_321;
reg    ap_enable_reg_pp0_iter3;
reg   [0:0] tmp_1_reg_287_pp0_iter2_reg;
reg   [0:0] tmp_7_reg_321_pp0_iter2_reg;
reg   [31:0] i_reg_135;
reg   [0:0] match_reg_147;
reg   [31:0] length_read_reg_271;
wire   [31:0] tmp_fu_168_p2;
reg   [31:0] tmp_reg_276;
wire   [31:0] tmp_2_fu_174_p1;
reg   [31:0] tmp_2_reg_281;
...
reg   [63:0] trace_temp_data_V_reg_291;
reg   [7:0] trace_temp_keep_V_reg_296;
reg   [7:0] trace_temp_strb_V_reg_301;
reg   [0:0] trace_temp_user_V_reg_306;
reg   [0:0] trace_temp_id_V_reg_311;
reg   [0:0] trace_temp_dest_V_reg_316;
wire   [0:0] tmp_7_fu_226_p2;
wire   [0:0] trace_temp_last_V_fu_242_p2;
reg   [0:0] trace_temp_last_V_reg_326;
wire   [31:0] i_3_fu_258_p2;
reg    ap_enable_reg_pp0_iter0;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter1_state3;
reg   [31:0] ap_phi_mux_i_phi_fu_139_p4;
reg   [0:0] ap_phi_mux_match_phi_fu_151_p4;
reg   [31:0] ap_phi_mux_i_1_phi_fu_161_p4;
wire   [31:0] ap_phi_reg_pp0_iter1_i_1_reg_158;
wire   [31:0] i_2_fu_232_p2;
reg   [31:0] samples_fu_76;
wire   [31:0] samples_1_fu_247_p2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] tmp_3_fu_212_p1;
wire   [31:0] tmp_5_fu_216_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (tmp_1_fu_183_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_287 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_287_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_fu_226_p2 == 1'd1) & (tmp_1_reg_287 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_1_reg_287 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_fu_226_p2 == 1'd1) & (tmp_1_reg_287 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_852)) begin
        if ((tmp_7_fu_226_p2 == 1'd0)) begin
            ap_phi_mux_i_1_phi_fu_161_p4 = i_2_fu_232_p2;
        end else if ((tmp_7_fu_226_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (tmp_1_reg_287 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (tmp_1_reg_287_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (tmp_7_reg_321_pp0_iter2_reg == 1'd1) & (tmp_1_reg_287_pp0_iter2_reg == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0) & (tmp_7_reg_321 == 1'd1) & (tmp_1_reg_287_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((tmp_1_reg_287 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_1_reg_287 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_1_reg_287 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((tmp_1_reg_287 == 1'd1) & (trace_64_data_V_0_vld_out == 1'b0));
end
...
always @ (*) begin
    ap_condition_852 = ((1'b0 == ap_block_pp0_stage0) & (tmp_1_reg_287 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter1_i_1_reg_158 = 'bx;

always @ (*) begin
    ap_predicate_op62_write_state4 = ((tmp_7_reg_321 == 1'd1) & (tmp_1_reg_287_pp0_iter1_reg == 1'd1));
end

always @ (*) begin
    ap_predicate_op65_write_state5 = ((tmp_7_reg_321_pp0_iter2_reg == 1'd1) & (tmp_1_reg_287_pp0_iter2_reg == 1'd1));
end
...
assign i_2_fu_232_p2 = ($signed(i_reg_135) + $signed(32'd4294967295));

assign i_3_fu_258_p2 = (ap_phi_mux_i_1_phi_fu_161_p4 + 32'd1);

assign samples_1_fu_247_p2 = (samples_fu_76 + 32'd1);

assign tmp_1_fu_183_p2 = (($signed(ap_phi_mux_i_phi_fu_139_p4) < $signed(length_read_reg_271)) ? 1'b1 : 1'b0);

assign tmp_2_fu_174_p1 = trigger_V[31:0];

assign tmp_3_fu_212_p1 = trace_64_data_V_0_data_out[31:0];

assign tmp_5_fu_216_p2 = (tmp_3_fu_212_p1 & tmp_2_reg_281);

assign tmp_6_fu_221_p2 = ((tmp_5_fu_216_p2 == tmp_2_reg_281) ? 1'b1 : 1'b0);

assign tmp_7_fu_226_p2 = (tmp_6_fu_221_p2 | ap_phi_mux_match_phi_fu_151_p4);

assign tmp_fu_168_p2 = ($signed(32'd4294967295) + $signed(length_r));
...
assign trace_temp_last_V_fu_242_p2 = ((samples_fu_76 == tmp_reg_276) ? 1'b1 : 1'b0);
