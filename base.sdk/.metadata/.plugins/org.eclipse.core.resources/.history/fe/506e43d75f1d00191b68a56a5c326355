 ...
 */
void SparkFun_APDS9960::wireWriteByte(uint8_t data){
 ...
 * @return True if successful write operation. False otherwise.
 */
void SparkFun_APDS9960::wireWriteDataByte(uint8_t regAddr, uint8_t data){
    uint8_t temp[2];
    temp[0] = regAddr;
    temp[1] = data;
 ...
 * @return True if successful write operation. False otherwise.
 */
void SparkFun_APDS9960::wireWriteDataBlock(uint8_t regAddr,
 ...
 */
int SparkFun_APDS9960::wireReadDataByte(uint8_t regAddr, uint8_t *data){
 ...
 */
int SparkFun_APDS9960::wireReadDataBlock(uint8_t devAddr, uint8_t regAddr,
                uint8_t *data, uint8_t length){
    i2c_write(device, APDS9960_I2C_ADDR, &regAddr, 1);
