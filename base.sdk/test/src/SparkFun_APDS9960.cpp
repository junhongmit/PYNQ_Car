...
/**
 * @brief Writes a single byte to the I2C APDS9960_device (no register)
 *
 * @param[in] val the 1-byte value to write to the I2C APDS9960_device
 * @return True if successful write operation. False otherwise.
 */
bool SparkFun_APDS9960::wireWriteByte(uint8_t data){
    i2c_write(APDS9960_device, APDS9960_I2C_ADDR, &data, 1);
    return true;
}
...
/**
 * @brief Writes a single byte to the I2C APDS9960_device and specified register
 *
 * @param[in] reg the register in the I2C APDS9960_device to write to
 * @param[in] val the 1-byte value to write to the I2C APDS9960_device
 * @return True if successful write operation. False otherwise.
 */
bool SparkFun_APDS9960::wireWriteDataByte(uint8_t regAddr, uint8_t data){
    uint8_t temp[2];
    temp[0] = regAddr;
    temp[1] = data;
    i2c_write(APDS9960_device, APDS9960_I2C_ADDR, temp, 2);
    return true;
}
...
/**
 * @brief Writes a block (array) of bytes to the I2C APDS9960_device and register
 *
 * @param[in] reg the register in the I2C APDS9960_device to write to
 ...
 * @return True if successful write operation. False otherwise.
 */
bool SparkFun_APDS9960::wireWriteDataBlock(uint8_t regAddr,
    ...
    i2c_write(APDS9960_device, APDS9960_I2C_ADDR, temp, len_total);
    return true;
}
...
/**
 * @brief Reads a single byte from the I2C APDS9960_device and specified register
 *
 * @param[in] reg the register to read from
 * @param[out] the value returned from the register
 * @return True if successful read operation. False otherwise.
 */
bool SparkFun_APDS9960::wireReadDataByte(uint8_t regAddr, uint8_t &data){
    i2c_write(APDS9960_device, APDS9960_I2C_ADDR, &regAddr, 1);
    i2c_read(APDS9960_device, APDS9960_I2C_ADDR, &data, 1);
    return 1;
}
...
/**
 * @brief Reads a block (array) of bytes from the I2C APDS9960_device and register
 *
 * @param[in] reg the register to read from
 ...
 */
int SparkFun_APDS9960::wireReadDataBlock(uint8_t regAddr,
                uint8_t *data, unsigned int length){
    i2c_write(APDS9960_device, APDS9960_I2C_ADDR, &regAddr, 1);
    i2c_read(APDS9960_device, APDS9960_I2C_ADDR, data, length);
    return length;
}
