...
user.org:user:PulseCounter:1.0\
...
# Hierarchical cell: uart_subsystem
proc create_hier_cell_uart_subsystem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_uart_subsystem() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: uartlite1, and set properties
  set uartlite1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite:2.0 uartlite1 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins UART] [get_bd_intf_pins uartlite1/UART]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins uartlite1/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins uartlite/S_AXI]
  connect_bd_intf_net -intf_net uartlite_UART [get_bd_intf_pins UART1] [get_bd_intf_pins uartlite/UART]

  # Create port connections
  connect_bd_net -net mb3_uartlite_interrupt [get_bd_pins interrupt1] [get_bd_pins uartlite/interrupt]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins clk_100M] [get_bd_pins uartlite/s_axi_aclk] [get_bd_pins uartlite1/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins uartlite/s_axi_aresetn] [get_bd_pins uartlite1/s_axi_aresetn]
  connect_bd_net -net uartlite1_interrupt [get_bd_pins interrupt] [get_bd_pins uartlite1/interrupt]
...
# Hierarchical cell: PulseCounter_subsystem
proc create_hier_cell_PulseCounter_subsystem { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_PulseCounter_subsystem() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -from 19 -to 0 CH_i
  ...
  set PulseCounter_0 [ create_bd_cell -type ip -vlnv user.org:user:PulseCounter:1.0 PulseCounter_0 ]

  # Create instance: PulseCounter_1, and set properties
  set PulseCounter_1 [ create_bd_cell -type ip -vlnv user.org:user:PulseCounter:1.0 PulseCounter_1 ]

  # Create instance: PulseCounter_2, and set properties
  set PulseCounter_2 [ create_bd_cell -type ip -vlnv user.org:user:PulseCounter:1.0 PulseCounter_2 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins PulseCounter_0/S_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins PulseCounter_2/S_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI2] [get_bd_intf_pins PulseCounter_1/S_AXI]

  # Create port connections
  connect_bd_net -net Din_0_1 [get_bd_pins CH_i] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_11/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  connect_bd_net -net FCLK_CLK0_1 [get_bd_pins FCLK_CLK0] [get_bd_pins PulseCounter_0/s_axi_aclk] [get_bd_pins PulseCounter_1/s_axi_aclk] [get_bd_pins PulseCounter_2/s_axi_aclk]
  connect_bd_net -net peripheral_aresetn_1 [get_bd_pins peripheral_aresetn] [get_bd_pins PulseCounter_0/s_axi_aresetn] [get_bd_pins PulseCounter_1/s_axi_aresetn] [get_bd_pins PulseCounter_2/s_axi_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins PulseCounter_2/CHA0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins PulseCounter_1/CHA1] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_11_Dout [get_bd_pins PulseCounter_1/CHB1] [get_bd_pins xlslice_11/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins PulseCounter_2/CHB0] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins PulseCounter_2/CHA1] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins PulseCounter_2/CHB1] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins PulseCounter_0/CHA0] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins PulseCounter_0/CHB0] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins PulseCounter_0/CHA1] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins PulseCounter_0/CHB1] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins PulseCounter_1/CHA0] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net xlslice_9_Dout [get_bd_pins PulseCounter_1/CHB0] [get_bd_pins xlslice_9/Dout]
...
proc create_hier_cell_iop_arduino { parentCell nameHier } {
  ...
  # Create instance: PulseCounter_subsystem
  create_hier_cell_PulseCounter_subsystem $hier_obj PulseCounter_subsystem
  ...
  # Create instance: uart_subsystem
  create_hier_cell_uart_subsystem $hier_obj uart_subsystem
  ...
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins io_switch/uart1] [get_bd_intf_pins uart_subsystem/UART]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI] [get_bd_intf_pins spi_subsystem/S01_AXILite]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI] [get_bd_intf_pins uart_subsystem/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI] [get_bd_intf_pins uart_subsystem/S_AXI1]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI] [get_bd_intf_pins timers_subsystem/S00_AXILite]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI] [get_bd_intf_pins timers_subsystem/S01_AXILite]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M17_AXI [get_bd_intf_pins PulseCounter_subsystem/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M17_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M18_AXI [get_bd_intf_pins PulseCounter_subsystem/S_AXI1] [get_bd_intf_pins microblaze_0_axi_periph/M18_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M19_AXI [get_bd_intf_pins PulseCounter_subsystem/S_AXI2] [get_bd_intf_pins microblaze_0_axi_periph/M19_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins DEBUG] [get_bd_intf_pins mb/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins lmb/DLMB] [get_bd_intf_pins mb/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins lmb/ILMB] [get_bd_intf_pins mb/ILMB]
  ...
  connect_bd_intf_net -intf_net uartlite_UART [get_bd_intf_pins io_switch/uart0] [get_bd_intf_pins uart_subsystem/UART1]

  # Create port connections
  connect_bd_net -net CH_i_1 [get_bd_pins PulseCounter_subsystem/CH_i] [get_bd_pins io_switch/gpio_data_i]
  ...
  connect_bd_net -net mb3_uartlite_interrupt [get_bd_pins interrupt_concat/In4] [get_bd_pins uart_subsystem/interrupt1]
  connect_bd_net -net mb_1_reset_Dout [get_bd_pins aux_reset_in] [get_bd_pins rst_clk_wiz_1_100M/aux_reset_in]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mb_debug_sys_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins clk_100M] [get_bd_pins PulseCounter_subsystem/FCLK_CLK0] [get_bd_pins arduino_gpio/s_axi_aclk] [get_bd_pins dff_en_reset_vector_0/clk] [get_bd_pins iic_direct/s_axi_aclk] [get_bd_pins intc/s_axi_aclk] [get_bd_pins intr/s_axi_aclk] [get_bd_pins io_switch/s_axi_aclk] [get_bd_pins lmb/LMB_Clk] [get_bd_pins mb/Clk] [get_bd_pins mb_bram_ctrl/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/M10_ACLK] [get_bd_pins microblaze_0_axi_periph/M11_ACLK] [get_bd_pins microblaze_0_axi_periph/M12_ACLK] [get_bd_pins microblaze_0_axi_periph/M13_ACLK] [get_bd_pins microblaze_0_axi_periph/M14_ACLK] [get_bd_pins microblaze_0_axi_periph/M15_ACLK] [get_bd_pins microblaze_0_axi_periph/M16_ACLK] [get_bd_pins microblaze_0_axi_periph/M17_ACLK] [get_bd_pins microblaze_0_axi_periph/M18_ACLK] [get_bd_pins microblaze_0_axi_periph/M19_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins spi_subsystem/s_axi_aclk] [get_bd_pins timers_subsystem/s_axi_aclk] [get_bd_pins uart_subsystem/clk_100M] [get_bd_pins xadc/s_axi_aclk]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins lmb/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_1_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins mb/Reset] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins PulseCounter_subsystem/peripheral_aresetn] [get_bd_pins intr/s_axi_aresetn] [get_bd_pins mb_bram_ctrl/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M14_ARESETN] [get_bd_pins microblaze_0_axi_periph/M16_ARESETN] [get_bd_pins microblaze_0_axi_periph/M18_ARESETN] [get_bd_pins microblaze_0_axi_periph/M19_ARESETN] [get_bd_pins spi_subsystem/s_axi_aresetn1] [get_bd_pins timers_subsystem/s_axi_aresetn1] [get_bd_pins uart_subsystem/s_axi_aresetn] [get_bd_pins xadc/s_axi_aresetn]
  ...
  connect_bd_net -net uartlite1_interrupt [get_bd_pins interrupt_concat/In6] [get_bd_pins uart_subsystem/interrupt]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces iop_arduino/mb/Data] [get_bd_addr_segs iop_arduino/PulseCounter_subsystem/PulseCounter_0/S_AXI/S_AXI_reg] SEG_PulseCounter_0_S_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces iop_arduino/mb/Data] [get_bd_addr_segs iop_arduino/PulseCounter_subsystem/PulseCounter_1/S_AXI/S_AXI_reg] SEG_PulseCounter_1_S_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces iop_arduino/mb/Data] [get_bd_addr_segs iop_arduino/PulseCounter_subsystem/PulseCounter_2/S_AXI/S_AXI_reg] SEG_PulseCounter_2_S_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40600000 [get_bd_addr_spaces iop_arduino/mb/Data] [get_bd_addr_segs iop_arduino/uart_subsystem/uartlite/S_AXI/Reg] SEG_mb3_uartlite_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40610000 [get_bd_addr_spaces iop_arduino/mb/Data] [get_bd_addr_segs iop_arduino/uart_subsystem/uartlite1/S_AXI/Reg] SEG_uartlite1_Reg
