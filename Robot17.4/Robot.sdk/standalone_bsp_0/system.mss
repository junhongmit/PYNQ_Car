...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = PulseCounter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = iop_arduino_PulseCounter_subsystem_PulseCounter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = PulseCounter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = iop_arduino_PulseCounter_subsystem_PulseCounter_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = PulseCounter
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = iop_arduino_PulseCounter_subsystem_PulseCounter_2
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = iop_arduino_uart_subsystem_uartlite
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = iop_arduino_uart_subsystem_uartlite1
END
