...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_io_switch_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_io_switch_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_io_switch_2.tcl
