...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_timer_0_1.tcl
