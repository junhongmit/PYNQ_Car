...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_intr_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_intr_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_intr_3.tcl
