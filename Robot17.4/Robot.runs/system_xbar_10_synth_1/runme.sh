...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_xbar_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xbar_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xbar_10.tcl
