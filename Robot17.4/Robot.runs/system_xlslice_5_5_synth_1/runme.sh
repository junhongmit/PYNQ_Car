...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_xlslice_5_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlslice_5_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlslice_5_5.tcl
