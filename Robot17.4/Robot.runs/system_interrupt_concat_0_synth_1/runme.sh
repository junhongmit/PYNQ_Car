...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_interrupt_concat_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_interrupt_concat_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_interrupt_concat_0.tcl
