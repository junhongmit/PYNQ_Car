...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_PulseCounter_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PulseCounter_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PulseCounter_0_2.tcl
