...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_mb_iop_rpi_intr_ack_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mb_iop_rpi_intr_ack_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mb_iop_rpi_intr_ack_0.tcl
