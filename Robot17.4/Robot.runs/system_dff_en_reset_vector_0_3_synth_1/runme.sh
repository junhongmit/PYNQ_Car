...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_dff_en_reset_vector_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_dff_en_reset_vector_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_dff_en_reset_vector_0_3.tcl
