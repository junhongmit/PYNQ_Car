...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_mb4_timer_pwm_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_mb4_timer_pwm_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_mb4_timer_pwm_0.tcl
