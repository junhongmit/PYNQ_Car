...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot/Robot.runs/system_lmb_bram_if_cntlr_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_lmb_bram_if_cntlr_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_lmb_bram_if_cntlr_3.tcl
