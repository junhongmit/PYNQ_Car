...
HD_PWD='/home/junhonglin/Xilinx/PYNQ_Car/Robot_test/Robot_test.runs/system_logic_1_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_logic_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_logic_1_4.tcl
